...
public class CosmeticModelRenderer {
	...
	public CosmeticModelRenderer addBox(String p_78786_1_, float p_78786_2_, float p_78786_3_, float p_78786_4_,
			int p_78786_5_, int p_78786_6_, int p_78786_7_) {
		p_78786_1_ = this.boxName + "." + p_78786_1_;
		TextureOffset textureoffset = this.baseModel.getTextureOffset(p_78786_1_);
		this.setTextureOffset(textureoffset.textureOffsetX, textureoffset.textureOffsetY);
		this.cubeList.add((new CosmeticModelBox(this, this.textureOffsetX, this.textureOffsetY, p_78786_2_, p_78786_3_,
				p_78786_4_, p_78786_5_, p_78786_6_, p_78786_7_, 0.0F)).func_78244_a(p_78786_1_));
		return this;
	}

	public CosmeticModelRenderer addBox(float p_78789_1_, float p_78789_2_, float p_78789_3_, int p_78789_4_,
			int p_78789_5_, int p_78789_6_) {
		this.cubeList.add(new CosmeticModelBox(this, this.textureOffsetX, this.textureOffsetY, p_78789_1_, p_78789_2_,
	...
	public void addBox(float p_78790_1_, float p_78790_2_, float p_78790_3_, int p_78790_4_, int p_78790_5_,
		...
		this.cubeList.add(new CosmeticModelBox(this, this.textureOffsetX, this.textureOffsetY, p_78790_1_, p_78790_2_,
				...
				if (this.rotationPointX == 0.0F && this.rotationPointY == 0.0F && this.rotationPointZ == 0.0F) {
					...
					if (this.childModels != null) {
						for (i = 0; i < this.childModels.size(); ++i) {
							((CosmeticModelRenderer) this.childModels.get(i)).render(p_78785_1_);
						}
					}
	...
	private void compileDisplayList(float p_78788_1_) {
		...
		for (int i = 0; i < this.cubeList.size(); ++i) {
			((CosmeticModelBox) this.cubeList.get(i)).render(worldrenderer, p_78788_1_);
		}
	...
	public void renderCosmetic(Entity entityIn, float ticks_2, float ticks_3, float ticks_4, float ticks_5,
			float ticks_6, float scale, float partialTicks) {
	...
	public void bindCosmeticTexture(String type, String name) {
		Minecraft.getMinecraft().getTextureManager()
				.bindTexture(new ResourceLocation("textures/cosmetics/" + type + "/" + name));
	}
	...
	public void renderItem(ItemStack item) {
		Minecraft.getMinecraft().getItemRenderer().renderItem((EntityLivingBase) this.entityIn, item,
				TransformType.NONE);
	}
